package com.gitee.xiaosongstudy.fcs.asserts;


import com.gitee.xiaosongstudy.fcs.exception.BusinessException;
import com.gitee.xiaosongstudy.fcs.utils.StringUtil;
...
public class BusinessAssert {
    ...
    public static void hasText(String validateStr, String message) {
        doAssert(StringUtil.isNotEmpty(validateStr), message);
    }
    ...
    public static void eq(String strOne, String StrTwo, String message) {
        boolean flag = StringUtil.isNotEmpty(strOne) && StringUtil.isNotEmpty(StrTwo) && strOne.equals(StrTwo);
